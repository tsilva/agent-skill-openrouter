...
Copy-paste templates for creating new skills.
...
```bash
python plugins/claude-skill-author/skills/claude-skill-author/scripts/validate_skill.py plugins/{plugin-name}/skills/{skill-name}
```
